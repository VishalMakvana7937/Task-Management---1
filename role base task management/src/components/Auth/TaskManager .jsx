  ...
  return (
    <div className={`dashboard ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="content">
        ...
        <Container className="uplod-task mt-4">

          <br />
          {/* Add your task management features here */}
          <Row>
            <Col md={12}>
              <Form className=''>
                <Form.Group>
                  <Form.Label>Upload Tasks</Form.Label>
                  <Form.Control type="file" className='uplod-input' />
                </Form.Group>
                <br />
